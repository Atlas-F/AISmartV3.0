...
const QMap<QString, QStringList> CommandSystem::appMap = []{
    ...
    map.insert("me", {"D:/ME/Adobe Media Encoder 2021/Adobe Media Encoder.exe"});
    map.insert("pr", {"D:/PR/Adobe Premiere Pro 2021/Adobe Premiere Pro.exe"});
    ...
    map.insert("clash", {"C:/Users/phoen/Downloads/Clash.for.Windows-0.20.38-win/Clash for Windows.exe"});
    ...
    map.insert("vscode", {"C:/Users/phoen/AppData/Local/Programs/Microsoft VS Code/Code.exe"});
    map.insert("coh2语言切换工具", {"H:/SteamLibrary/steamapps/common/Company of Heroes 2/COH2语言切换工具.exe"});
    map.insert("控制面板", {"C:/WINDOWS/system32/control.exe"});
    ...
    map.insert("qtdesigner", {"D:/QTcreator/6.9.1/mingw_64/bin/designer.exe"});
    map.insert("devenv", {"D:/VSStudioComm2022/Common7/IDE/devenv.exe"});
    map.insert("dfrgui", {"C:/WINDOWS/system32/dfrgui.exe"});
    map.insert("钉钉", {"D:/钉钉/DingDing/DingtalkLauncher.exe"});
    map.insert("豆包", {"C:/Users/phoen/AppData/Local/Doubao/Doubao.exe"});
    ...
    map.insert("eve", {"E:/EVE/Launcher/evelauncher.exe"});
    map.insert("文件资源管理器", {"C:/WINDOWS/explorer.exe"});
    ...
    map.insert("ps", {"D:/PS/Adobe Photoshop 2021/Photoshop.exe"});
    ...
    map.insert("squareline", {"D:/SquareLine Studio 1.4.2/SquareLine_Studio.exe"});
    ...
    map.insert("uu", {"D:/Netease/UU/uu_launcher.exe"});
    map.insert("keil5", {"D:/Keil_v5/UV4/UV4.exe"});
    ...
    map.insert("微信", {"D:/Weixin/Weixin.exe"});
    ...
    map.insert("wps", {"D:/WPS Office/ksolaunch.exe"});
    ...
    map.insert("迅雷", {"D:/Thunder/Program/ThunderStart.exe"});
