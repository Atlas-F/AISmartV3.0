...
namespace {
struct qt_meta_tag_ZN15TransformWidgetE_t {};
} // unnamed namespace

template <> constexpr inline auto TransformWidget::qt_create_metaobjectdata<qt_meta_tag_ZN15TransformWidgetE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<TransformWidget, qt_meta_tag_ZN15TransformWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject TransformWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15TransformWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15TransformWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN15TransformWidgetE_t>.metaTypes,
    nullptr
} };
...
void *TransformWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15TransformWidgetE_t>.strings))
